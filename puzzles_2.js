fetch("./data/puzzles.json")
  ...
  .then(puzzles => {
    ...
    function updateImg() {
      ...
      col1.classList.remove("category-1-puzzle-1","category-1-puzzle-2","category-1-puzzle-3");
      col1.classList.add(`category-1-puzzle-${lvl}`);
    }
    ...
    nextBtn.addEventListener("click", ()=>{
      if (!nextBtn.disabled) alert("Parabéns! Você pode avançar.");
    });
  });
